...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function updateTextareaAddress () {
            ...
            if (ward_code) {
                address.push($(`#ward_code option[value=${ward_code}]`).text().trim());
            }

            const district_code = $('#district_code').val();
            if (district_code) {
                address.push($(`#district_code option[value=${district_code}]`).text().trim());
            }

            const province_code = $('#province_code').val();
            if (province_code) {
                address.push($(`#province_code option[value=${province_code}]`).text().trim());
            }
